...
import './main.scss';
import './fonts.scss';
import './scss/search-form/search-form.scss';
import './scss/search-form/chips.scss';

import Chips from './js/chips.js';

const arrCountries = [];

let form1 = document.querySelector('.country1');
let form2 = document.querySelector('.country2');

let obj1, obj2;

fetch('https://crossorigin.me/http://country.io/names.json')
